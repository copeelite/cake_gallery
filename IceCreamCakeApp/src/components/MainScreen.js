...
const MainScreen = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState(upcomingHolidays[0].name);
  ...
  return (
    <SafeAreaView style={styles.container} {...panResponder.panHandlers}>
      ...
      >
        <ProductList title={selectedCategory} />
      </Animated.View>
      <Pressable onPress={toggleMenuBar} style={styles.iconContainer}>
